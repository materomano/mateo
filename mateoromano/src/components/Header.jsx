...
import { encabezado } from '../Estilos/header.module.css'; // Importa estilos locales de módulo CSS
import { useLang } from './LangContext'; // Asumiendo que tienes un contexto de idioma
